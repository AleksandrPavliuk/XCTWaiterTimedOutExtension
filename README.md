...
final class SomeMediatorTests: XCTestCase {
    ...
    func testRefreshUnreadNotificationsEndedSuccessfully() {
		...
		// Closure will be executed after delay, in that case all async operations inside view updating process will have time to execute
        XCTWaiter.waitForExpectation(
            withDescription: "Waiting for notifications refresh",
            timedOut: 1,
            andVerify: {
            	// In the end of process, mediator should trigger view to update and give new viewModel for that, error should be nil
    ...
    func testRefreshUnreadNotificationsEndedFailure() {
        ...
        XCTWaiter.waitForExpectation(
            ...
            timedOut: 1,
            andVerify: {
            	// In the end of process, mediator should trigger view to update and give error instance, viewModel should be nil
